...
export type Query = {
  __typename?: 'Query';
  isUpdateAvailable?: Maybe<Scalars['Boolean']>;
  settings: Settings;
};
...
export type GetSettingsQuery = { __typename?: 'Query', settings: { __typename?: 'Settings', isReady: boolean, availableDevices: Array<string>, modelsFilePath: string, device: string, showPreviews: boolean, stepsPerPreview: number, useFullPrecision: boolean, models: Array<{ __typename?: 'SettingsModel', isActive: boolean, id: string, name: string, weightsFilename: string, configFilename: string, width: number, height: number }> } };

export type GetSettingsForDreamQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSettingsForDreamQuery = { __typename?: 'Query', settings: { __typename?: 'Settings', isReady: boolean, activeModel?: { __typename?: 'SettingsModel', width: number, height: number } | null } };

export type IsUpdateAvailableQueryVariables = Exact<{ [key: string]: never; }>;


export type IsUpdateAvailableQuery = { __typename?: 'Query', isUpdateAvailable?: boolean | null };
...
export type WatchDreamSubscription = { __typename?: 'Subscription', watchDream: { __typename: 'FinishedDream', id: string, images: Array<{ __typename: 'FinishedDreamImage', imagePath: string, width: number, height: number, id: string }> } | { __typename: 'PendingDream', id: string, images: Array<{ __typename: 'PendingDreamImage', id: string }> } | { __typename: 'RunningDream', numFinishedImages: number, numTotalImages: number, numFinishedSteps: number, numTotalSteps: number, id: string, images: Array<{ __typename: 'FinishedDreamImage', imagePath: string, width: number, height: number, id: string } | { __typename: 'PendingDreamImage', id: string } | { __typename: 'RunningDreamImage', numFinishedSteps: number, numTotalSteps: number, previewImagePath?: string | null, previewWidth?: number | null, previewHeight?: number | null, id: string } | { __typename: 'StoppedDreamImage', id: string }> } | { __typename: 'StoppedDream', reason: StoppedDreamReason, message?: string | null, id: string, images: Array<{ __typename: 'FinishedDreamImage', imagePath: string, width: number, height: number, id: string } | { __typename: 'PendingDreamImage', id: string } | { __typename: 'RunningDreamImage', numFinishedSteps: number, numTotalSteps: number, previewImagePath?: string | null, previewWidth?: number | null, previewHeight?: number | null, id: string } | { __typename: 'StoppedDreamImage', id: string }> } };
...
export const GetSettingsForDreamDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetSettingsForDream"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"settings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isReady"}},{"kind":"Field","name":{"kind":"Name","value":"activeModel"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"width"}},{"kind":"Field","name":{"kind":"Name","value":"height"}}]}}]}}]}}]} as unknown as DocumentNode<GetSettingsForDreamQuery, GetSettingsForDreamQueryVariables>;
export const IsUpdateAvailableDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"IsUpdateAvailable"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isUpdateAvailable"}}]}}]} as unknown as DocumentNode<IsUpdateAvailableQuery, IsUpdateAvailableQueryVariables>;
